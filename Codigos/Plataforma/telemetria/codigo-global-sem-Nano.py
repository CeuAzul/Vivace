...
velocidadeSubida = Dado("Velocidade de subida", "m/s", "ves", True, False, False, 2)
...
erroVelocidade = Dado("Erro de velocidade", "nós", "ers", True, False, False, 1)
erroVelocidadeSubida = Dado("Erro da velocidade de subida", "m/s", "ves", True, False, False, 1)
...
longitudeRef = Dado("Longitude de referência", "-", "lgr", True, True, False, 6)
posicaoX = Dado("XGPS", "m", "gpx", True, True, False, 2)
posicaoY = Dado("YGPS", "m", "gpy", True, True, False, 2)
distanciaAbsoluta = Dado("Distancia absoluta", "m", "dtr", True, False, False, 2)
