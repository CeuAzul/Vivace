...
velocidadeSubida = Dado("Velocidade de subida", "m/s", "ves", False, False, False, 2)
...
erroVelocidade = Dado("Erro de velocidade", "nós", "ers", False, False, False, 1)
erroVelocidadeSubida = Dado("Erro da velocidade de subida", "m/s", "ves", False, False, False, 1)
...
longitudeRef = Dado("Longitude de referência", "-", "lgr", False, True, False, 6)
posicaoX = Dado("XGPS", "m", "gpx", True, True, False, 2)
posicaoY = Dado("YGPS", "m", "gpy", True, True, False, 2)
distanciaAbsoluta = Dado("Distancia absoluta", "m", "dtr", False, False, False, 2)
...
def modoDeTransmissao(modo):
         ...
         if (modo == 0 or modo == 1): 
             ...
             cor1.setTransmissao(False)
             cor2.setTransmissao(False)
             cor3.setTransmissao(False)
             voltBat.setTransmissao(False)
             pwm1.setTransmissao(False)
             pwm2.setTransmissao(False)
             pwm3.setTransmissao(False)
         elif modo == 2: #2 = Apenas transmitindo tempo, Vcas, HP, RPM e altitude(gps)
             ...
             cor2.setTransmissao(False)
             cor3.setTransmissao(False)
             voltBat.setTransmissao(True)
             pwm1.setTransmissao(True)
             pwm2.setTransmissao(True)
             pwm3.setTransmissao(True)
...
def atualizaBarometro(delay):
    ...
    while threadsRodando:
        ...
        pressaoTotal.setValor(barometro.getPressao("PA")+pitot8b.getPressaoDinamica("PA"))
        pressaoTotalr.setValor(barometro.getPressao("PA")+pitot8b.getPressaoDinamica("PA"))
...
tNano = threading.Thread(target=atualizaNano, args=(0.2,))
