...
distanciaReferencia = Dado("Distância de referência", "cm", "dsr", True, True, False)
...
def atualizaEscritor():
    ...
    """
    d = [tempo, item, distanciaAtual, distanciaReferencia, distanciaMaxima, elevacaoMinima, wowRaw]
    escritor.setDados(d)
